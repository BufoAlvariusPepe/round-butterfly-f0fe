...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/image-ai)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/image-ai
```

A live public deployment of this template is available at [https://image-ai.templates.workers.dev](https://image-ai.templates.workers.dev)
